...
suite "report":
  test "daily-report scenario produces human-checkable artifacts":
    ...
    check output.reportMarkdown.contains("## Flow health")
    check output.reportMarkdown.contains("## Operational summary")
    ...
    check output.reportMarkdown.contains("Health reasons")
    ...
    check output.reportHtml.contains("Health")
    check output.reportHtml.contains("Throughput")
    check output.reportHtml.contains("Failure rate")
